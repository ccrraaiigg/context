#!/bin/sh
# 
# Launch spoon from a menu, prompting for and/or installing an image
# 
# Last edited: 2011-07-20 16:30:21 by craig on netjam
...
result=../../Resources/Spoon3alpha4.image
